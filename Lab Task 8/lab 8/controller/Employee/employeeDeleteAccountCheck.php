...
require_once('../../Model/Employee/employeeModel.php');
    ...
    if(strlen($_POST['password'])>=8)
		...
		if($check === false)
		{
			echo ' Wrong password <a href="../../View/Employee/employeeDeleteAccount.php">Back</a>';
		}
      ...
      if ( $_SESSION['password'] == $_POST['password'] ) {
        ...
        echo "Incorrect current password".'<a href="../../View/Employee/employeeDeleteAccount.php"> try again</a>';
      }
