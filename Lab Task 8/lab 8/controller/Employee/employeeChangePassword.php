...
require_once('../../Model/Employee/employeeModel.php');
	if(isset($_POST['submit']))
	{
		...
		{
			echo 'Password must not be less than eight (8) characters <a href="../../View/Employee/
			employeeChangePassword.php">Go Back</a>';
		}
    if(strlen($_POST['newPass'])>=8)
		{
		...
		if($check === false)
		{
			echo 'Password must contain at least one of the special characters (@, #, $, %) <a href="../../View/Employee/employeeChangePassword.php">Go Back</a>';
		}
    else if($_POST['newPass']!=$_POST['retypePass']){
        echo 'New Password and retyped did not matched <a href="../../View//employeeChangePassword.php">Go Back</a>';
    }
...
echo "Incorrect current password".'<a href="../../View/Employee/employeeChangePassword.php"> Reload </a>';
}
